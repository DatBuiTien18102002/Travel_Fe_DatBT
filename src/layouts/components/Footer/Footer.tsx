...
const Footer = () => {
  return (
    <footer className="relative bg-footer bg-no-repeat bg-center bg-cover">
      ...
      <div className="relative z-2 wrapper py-[40px] text-white border-t-[4px] border-sky border-b-[2px]">
        <Row gutter={[16, 16]}>
          <Col lg={8} xs={24}>
            <div className="font-logo text-sunny text-4xl">DAT Travel</div>

            <p className="pt-4 text-lg">
              Chúng tôi luôn mong muốn mang đến cho khách hàng những trải nghiệm
              tốt nhất, tạo ra những khoảng khắc khó quên khi đồng hành cùng
              chúng tôi.
            </p>
          </Col>
          <Col lg={6} sm={10} xs={24}>
            ...
            <p className="pt-4 flex flex-col gap-3">
              <div>
                <div className="font-robotoBold ">Cơ sở 1</div>

                <div>
                  128/5 Bùi Quang Là, Phường 12, Q.Gò Vấp, Tp.Hồ Chí Minh, Việt
                  Nam
                </div>
              </div>
              ...
              <div>
                ...
                <div>
                  57/41 Phan Huy Ích, Phường 12, Q.Gò Vấp, Tp.Hồ Chí Minh, Việt
                  Nam
                </div>
              </div>
            </p>
